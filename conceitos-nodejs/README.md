...
O objetivo do desafio era criar uma aplicação para colocar em prática os conhecimentos em Node.js adquiridos durante o bootcamp.

A aplicação armazena repositórios do seu portfólio, permite a criação, listagem, atualização e remoção desses repositórios, e além disso permite que os repositórios possam receber "likes".
